    ...
    public partial class Parser 
    {
        ...
        private void ParseStart(ParseNode parent) // NonTerminalSymbol: Start
        {
            ...
            parent.Nodes.Add(node);
             ...
             // Concat Rule
            tok = scanner.LookAhead(TokenType.FUNCTION, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.CONSTANT, TokenType.BRACKETOPEN, TokenType.PLUS, TokenType.MINUS, TokenType.NOT); // Option Rule
        ...
        private void ParseUnaryExpression(ParseNode parent) // NonTerminalSymbol: UnaryExpression
        {
            ...
            tok = scanner.LookAhead(TokenType.FUNCTION, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.CONSTANT, TokenType.BRACKETOPEN, TokenType.PLUS, TokenType.MINUS, TokenType.NOT); // Choice Rule
            switch (tok.Type)
            { // Choice Rule
        ...
        private void ParsePrimaryExpression(ParseNode parent) // NonTerminalSymbol: PrimaryExpression
        {
            ...
            tok = scanner.LookAhead(TokenType.FUNCTION, TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.CONSTANT, TokenType.BRACKETOPEN); // Choice Rule
            switch (tok.Type)
            { // Choice Rule
                case TokenType.FUNCTION:
        ...
        private void ParseLiteral(ParseNode parent) // NonTerminalSymbol: Literal
        {
            ...
            tok = scanner.LookAhead(TokenType.BOOLEANLITERAL, TokenType.DECIMALINTEGERLITERAL, TokenType.HEXINTEGERLITERAL, TokenType.REALLITERAL, TokenType.STRINGLITERAL, TokenType.CONSTANT); // Choice Rule
            switch (tok.Type)
            { // Choice Rule
                case TokenType.BOOLEANLITERAL:
                ...
                case TokenType.STRINGLITERAL:
                    ...
                    break;
                case TokenType.CONSTANT:
                    tok = scanner.Scan(TokenType.CONSTANT); // Terminal Rule: CONSTANT
                    n = node.CreateNode(tok, tok.ToString() );
                    node.Token.UpdateRange(tok);
                    node.Nodes.Add(n);
                    if (tok.Type != TokenType.CONSTANT) {
                        tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.CONSTANT.ToString(), 0x1001, 0, tok.StartPos, tok.StartPos, tok.Length));
                        return;
                    }
                    break;
                default:
